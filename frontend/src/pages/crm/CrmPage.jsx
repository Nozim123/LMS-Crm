...
export default function CrmPage() {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-semibold">CRM Leads</h2>
      ...
      <div className="bg-white rounded shadow overflow-x-auto">
        <table className="w-full text-sm">
          <thead className="bg-slate-100">
            <tr><th className="p-2 text-left">Student</th><th className="p-2 text-left">Parent</th><th className="p-2">Phone</th><th className="p-2">Stage</th></tr>
          </thead>
          <tbody>
            {leads.map((l) => (
              <tr key={l.id} className="border-t">
                <td className="p-2">{l.student_name}</td>
                <td className="p-2">{l.parent_name}</td>
