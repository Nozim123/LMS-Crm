...
## Role Selection + SMS Templates Enhancements

- Added **Choose Role** flow for users with multiple roles.
- Sidebar **Switch Role** now routes to role chooser when multiple roles exist.
- Added full **SMS Templates management UI** with:
  - search by title/content
  - category filter (`Follow-up`, `Reminder`, `Enrollment Confirmation`)
